...
This is a fork of this [repository](https://github.com/flast101/padding-oracle-attack-explained). I just added multithreading to speed up the cracking process, and I still need to implement initial padding detection to make it even faster.
